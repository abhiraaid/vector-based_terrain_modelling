...
public:
  static const Vec3I next[26];//!< %Array of 26 Vec3I representing the offsets of the 1-neighborhood points of a Vec3I.
...
inline constexpr int Vec3I::operator[] (int i) const
{
  return c[i];
}
...
/*!
\brief Return the k-th point in the 1-neighborhood of the point.
\param k Index.
*/
inline Vec3I Vec3I::Next(int k) const
{
  return (*this) + next[k];
}
...
//! Returns the i-th coordinate of vector.
inline constexpr int Vec2I::operator[] (int i) const
{
  return c[i];
}
...
//! Multiply.
inline Vec2I Vec2I::operator* (int a) const
{
  return Vec2I(c[0] * a,c[1] * a);
}
...
{
  return Vec2I(c[0] ^ v.c[0], c[1] ^ v.c[1]);
}
